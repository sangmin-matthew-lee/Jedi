...
object ValueTests1 extends App {
  try {
    ...
    println(Inexact(4) == Inexact(4)) // true
    ...
    println(Boole.TRUE || {
      print("eager "); Boole.FALSE
    }) // eager true
    println(Boole(true)==Boole(true)) //true

    println(Inexact(9) / Inexact(9))    // 1.0
    //println(Inexact(9) / Exact(0))    // context.IllegalValueException: Divide by 0!
